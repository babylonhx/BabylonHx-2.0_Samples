...
class Convolution {
	...
	public function new(scene:Scene) {
	    ...
	    var mat = new StandardMaterial("white", scene);
	    ...
	    material.diffuseColor = new Color3(1.0, 0.5, 0.5);
	    material.specularColor = new Color3(0, 0, 0);
	    cube.material = material;  
	    // Post-process
	    var postProcess = new ConvolutionPostProcess("convolution", [-2, -1, 0, -1, 1, 1, 0, 1, 2], 1.0, camera);
